    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                .route("order_service", r -> r.path("/order/**")
                        .filters(f -> f.circuitBreaker(c -> c.setName("CircuitBreaker").setFallbackUri("forward:/orderFallBack")))
                        .uri("lb://ORDER-SERVICE"))
                .route("payment_service", r -> r.path("/payment/**")
                        .filters(f -> f.circuitBreaker(c -> c.setName("CircuitBreaker").setFallbackUri("forward:/paymentFallBack")))
